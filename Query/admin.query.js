...
const selectModify = "SELECT * FROM modifier WHERE idPrestataire = $1";
const deleteModify = "DELETE FROM modifier WHERE idPrestataire = $1";
...
const updateStand = "UPDATE emplacements SET libelleEmplacement = $1 WHERE idEmplacement = $2";
...
const deleteStand = "DELETE FROM emplacements WHERE idEmplacement = $1";
